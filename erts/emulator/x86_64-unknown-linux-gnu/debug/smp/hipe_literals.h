/* File: hipe_literals.h, generated by /root/download/otp_src_19.3/bin/x86_64-unknown-linux-gnu/hipe_mkliterals.debug.smp */
...
#define P_BIF_CALLEE 216
#define P_MSG_FIRST 424
#define P_MSG_SAVE 440
#define P_CALLEE_EXP 160
#define THE_NON_VALUE -40
#define P_GCUNSAFE 224
#define HIPE_LITERALS_CRC 2320683U
#define HIPE_SYSTEM_CRC 9054806U
...
#define RTS_PARAMS_CASES \
	...
	case 48: value = 216; break; \
	case 49: value = 424; break; \
	case 50: value = 440; break; \
	case 51: value = 160; break; \
	case 52: value = -40; break; \
	case 53: value = 224; break;
#endif
