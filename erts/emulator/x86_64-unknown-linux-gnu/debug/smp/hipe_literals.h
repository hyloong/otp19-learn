/* File: hipe_literals.h, generated by /root/download/otp_src_20.0/bin/x86_64-unknown-linux-gnu/hipe_mkliterals.debug.smp */
...
#define P_FLAGS 376
#define P_FVALUE 384
#define P_FREASON 392
#define P_FTRACE 400
#define P_FCALLS 344
#define P_BEAM_IP 328
#define P_ARITY 248
#define P_ARG0 272
#define P_ARG1 280
#define P_ARG2 288
...
#define P_BIF_CALLEE 232
#define P_MSG_FIRST 432
#define P_MSG_SAVE 448
#define P_CALLEE_EXP 176
#define THE_NON_VALUE -40
#define P_GCUNSAFE 240
#define HIPE_LITERALS_CRC 122678986U
#define HIPE_SYSTEM_CRC 56040720U
...
#define RTS_PARAMS_CASES \
	...
	case 27: value = 376; break; \
	case 28: value = 384; break; \
	case 29: value = 392; break; \
	case 30: value = 400; break; \
	case 31: value = 344; break; \
	case 32: value = 328; break; \
	case 33: value = 248; break; \
	case 34: value = 272; break; \
	case 35: value = 280; break; \
	case 36: value = 288; break; \
	case 37: value = 296; break; \
	case 38: value = 304; break; \
	case 39: value = 312; break; \
	...
	case 48: value = 232; break; \
	case 49: value = 432; break; \
	case 50: value = 448; break; \
	case 51: value = 176; break; \
	case 52: value = -40; break; \
	case 53: value = 240; break;
#endif
