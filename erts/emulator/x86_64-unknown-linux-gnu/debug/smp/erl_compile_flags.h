...
const char* erts_build_flags_CFLAGS = "-g  -D_GNU_SOURCE -I/root/download/otp_src_19.3/erts/x86_64-unknown-linux-gnu    -DDEBUG -DERTS_SMP -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS -DERTS_ENABLE_LOCK_COUNT  ";
